...
public class RecurringRemindersModel extends RemindersModel{
    ...
    public RecurringRemindersModel(String reminder_name, Date reminder_date_time, VoiceProfileModel reminder_voice_profile, int number_repetition, int days_repetition) {
